...
export declare const INFINITY = "Infinity";
export declare const NEGATIVE_INFINITY = "NegativeInfinity";
...
export declare enum PropGetterState {
...
export declare const GLOBAL_GET_VALUE = "$SdtGetValue";
declare global {
    interface Window {
